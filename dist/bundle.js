...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"PageList\": () => (/* binding */ PageList)\n/* harmony export */ });\n/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! aos */ \"./node_modules/aos/dist/aos.js\");\n/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(aos__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var aos_dist_aos_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! aos/dist/aos.css */ \"./node_modules/aos/dist/aos.css\");\n\n\naos__WEBPACK_IMPORTED_MODULE_0___default().init();\nvar PageList = function PageList() {\n  var argument = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';\n  var searchTitle = argument.trim().replace(/\\s+/g, '-'); // Ajoutez cette ligne\n\n  var page = 1;\n  var displayedResults = 0;\n  var handleSearchByTitle = function handleSearchByTitle() {\n    var searchForm = document.getElementById(\"search-by-title-form\");\n    searchForm.addEventListener(\"submit\", function (event) {\n      event.preventDefault();\n      var titleInput = document.getElementById(\"t\");\n      var title = titleInput.value.trim();\n      var resultsContainer = document.querySelector('#results-row');\n      displayedResults = 0;\n      page = 1;\n      resultsContainer.innerHTML = \"\";\n      if (title) {\n        searchTitle = title; // Mettez à jour la valeur de searchTitle ici\n        var url = \"https://api.rawg.io/api/games?key=\".concat(\"b5e252b920d8429ab3f19a1361e345f4\", \"&search=\").concat(title);\n        fetchList(url, searchTitle);\n      }\n    });\n  };\n  var displayResults = function displayResults(articles) {\n    var limitedArticles = articles.slice(0, 9);\n    var resultsContent = limitedArticles.map(function (article) {\n      return \"<div class=\\\"col-md-4\\\">\\n        <a href=\\\"#pagedetail/\".concat(article.id, \"\\\" class=\\\"card-link\\\">\\n          <article class=\\\"cardGame\\\" data-aos=\\\"fade-up\\\">\\n            <div class=\\\"card-inner\\\">\\n              <div class=\\\"card-front\\\">\\n                <img src=\\\"\").concat(article.background_image, \"\\\" alt=\\\"image\\\">\\n              </div>\\n              <div class=\\\"card-back\\\">\\n                <h4>\").concat(article.released, \"</h4>\\n                <h4>\").concat(article.rating, \" (\").concat(article.ratings_count, \" votes)</h4>\\n              </div>\\n            </div>\\n            <div class=\\\"card-header\\\">\\n              <h3>\").concat(article.name, \"</h3>\\n            </div>\\n          </article>\\n        </a>\\n      </div>\");\n    });\n    var resultsContainer = document.querySelector('#results-row');\n    resultsContainer.innerHTML += resultsContent.join(\"\\n\");\n    displayedResults += limitedArticles.length;\n    if (displayedResults >= 27) {\n      var showMoreBtn = document.getElementById(\"show-more-btn\");\n      showMoreBtn.style.display = \"none\";\n    }\n  };\n  var fetchList = function fetchList(url, argument) {\n    var finalURL = argument ? \"\".concat(url, \"&search=\").concat(argument) : url;\n    fetch(finalURL).then(function (response) {\n      return response.json();\n    }).then(function (responseData) {\n      var filteredResults = responseData.results.filter(function (result) {\n        return result.rating !== null || result.rating !== 0;\n      });\n      displayResults(filteredResults);\n      console.log(filteredResults);\n    });\n  };\n  var loadMoreGames = function loadMoreGames() {\n    fetchList(\"https://api.rawg.io/api/games?key=\".concat(\"b5e252b920d8429ab3f19a1361e345f4\", \"&search=\").concat(searchTitle, \"&page=\").concat(page), searchTitle);\n    page++;\n    if (page > 3) {\n      var showMoreBtn = document.getElementById(\"show-more-btn\");\n      showMoreBtn.style.display = \"none\";\n    }\n  };\n  var render = function render() {\n    var pageContent = document.getElementById(\"card-container\");\n    pageContent.innerHTML = \"\\n      <div class=\\\"row\\\" id=\\\"results-row\\\"></div><br><br>\\n      <button class=\\\"btn btn-primary\\\" id=\\\"show-more-btn\\\">Show More</button>\\n    \";\n    var showMoreBtn = document.getElementById(\"show-more-btn\");\n    showMoreBtn.addEventListener(\"click\", loadMoreGames);\n    handleSearchByTitle(); // Ajoutez cet appel de fonction ici\n    loadMoreGames();\n  };\n  render();\n};\n\n\n//# sourceURL=webpack://0428/./src/js/PageList.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://0428/./node_modules/aos/dist/aos.css?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://0428/./src/style/index.scss?");
